...
const TIERS: Tier[] = [
	...
	},
	{
		...
		cta: 'Start Pro',
		href: '/signup',
		features: ['Unlimited sites', 'Advanced analytics', 'CI/CD pipelines', 'Email support', 'Daily backups'],
		highlighted: true,
	},
	{
		id: 'business',
		...
		cta: 'Contact Sales',
		href: '/about',
		features: ['Priority support', 'SLA & SSO', 'Custom integrations', 'Dedicated environment', 'Role-based access'],
	},
];
